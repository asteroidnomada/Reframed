    ...
    <div className="w-full max-w-sm">
      <div className="rounded-lg border border-border bg-bg p-8 shadow-md">
        ...
        <div className="my-5 flex items-center gap-3">
          ...
          <span className="text-xs text-fg-faint">or continue with email</span>
          <div className="h-px flex-1 bg-border" />
        </div>
        ...
        <form onSubmit={handleEmailSignIn} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link href="/forgot-password" className="text-xs text-fg-muted hover:text-fg transition-colors">
                Forgot password?
              </Link>
            </div>
            <Input
